                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="p">
                            <tr>
                                ...
                                <td>${p.quantity}</td>
                                <td>
                                    <a href="../loadproduct?pid=${p.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="../delete?pid=${p.id}" class="delete" data-toggle="modal">
